...
export function VigorDeleteForm({ title, itemName, backHref, deleteAction }: DeletePageProps) {
  const [state, formAction] = useActionState<ActionState, FormData>(deleteAction, undefined);
